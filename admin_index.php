...
$sql='SELECT COUNT(id) as count_user from mall_user';
$obj=mysqli_query($con,$sql);
$date1=mysqli_fetch_assoc($obj);

unset($sql,$obj);

$sql='SELECT count(id) as count_goods from mall_goods';
$obj=mysqli_query($con,$sql);
$date2=mysqli_fetch_assoc($obj);
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                        <span class="tpl-header-list-user-nick"><?php $user ?></span><span class="tpl-header-list-user-ico"><?echo $name?> </span>
                    </a>
                    <ul class="am-dropdown-content">
                        <li><a href="#"><span class="am-icon-bell-o"></span> 资料</a></li>
                        <li><a href="#"><span class="am-icon-cog"></span> 设置</a></li>
                        <li><a href="#" onclick="loginout();"><span class="am-icon-power-off"></span> 退出</a></li>
                    </ul>
                </li>
                ...
                <div class="am-u-sm-6">
                    <div class="dashboard-stat blue">
                        ...
                        <div class="details">
                            ...
                            <div class="number"> <?echo $date1['count_user']?> </div>                           
                        </div>
                        <a class="more" href="admin_user_list.php"> 查看更多
                ...
                <div class=" am-u-sm-6">
                    <div class="dashboard-stat red">
                        ...
                        <div class="details">
                            ...
                            <div class="number"><?echo $date2['count_goods']?></div>
